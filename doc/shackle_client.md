...
__This module defines the `shackle_client` behaviour.__<br /> Required callback functions: `after_connect/2`, `handle_data/2`, `handle_request/2`, `handle_timings/2`, `options/0`, `terminate/1`.
