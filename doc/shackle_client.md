...
__This module defines the `shackle_client` behaviour.__<br /> Required callback functions: `after_connect/2`, `handle_cast/2`, `handle_data/2`, `options/0`, `process_timings/2`, `terminate/1`.
